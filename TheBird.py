...
@app_commands.describe(
    id_cuestionario="ID del cuestionario que deseas eliminar"
)
@app_commands.checks.has_permissions(administrator=True)
async def borrar_cuestionario(interaction: discord.Interaction, id_cuestionario: str):
    ...
    guardar_datos(datos)
    await interaction.response.send_message(f"El cuestionario **{id_cuestionario}** ha sido eliminado correctamente.", ephemeral=True)
